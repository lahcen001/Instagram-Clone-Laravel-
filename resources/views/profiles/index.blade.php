...
<div class="container">
    <div class="row ">
        <div class="col-3 p-5">
            <img src="{{ asset($user->profile->getProfileImage()) }}" class="rounded-circle w-100 shadow-lg">
        </div>
        ...
        <div class="col-9 pt-5">
            <div class="d-flex align-items-center">
                ...
                @can('update', $user->profile)
                    <a class=" ml-3" href="/profile/{{$user->username}}/edit" role="button">
                        Edit Profile
                    </a>
                @else
    ...
    <div class="row pt-4 border-top">
        ...
        @forelse ($user->posts as $post)
            <div class="col-4 col-md-4 mb-4 align-self-stretch">
                <a href="/p/{{ $post->id }}">
                    <img class="img border shadow  rounded" height="300" src="{{ asset("storage/$post->image") }}">
                </a>
            </div>
        @empty
