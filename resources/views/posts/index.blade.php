...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-4 h-100 py-3 bg-white shadow-lg rounded">
            <!-- User Info -->
                ...
                @foreach ($sugg_users as $sugg_user)
                    ...
                    <div class='suggestions p-2'>
                        <div class="d-flex align-items-center ">
                            ...
                            <div class='d-flex flex-column pl-3 mr-5'>
                            ...
                            <follow-button user-id="{{ $sugg_user->username }}" follows=""></follow-button>
                        </div>
                    </div>
                @endforeach
            ...
            <!-- CopyRight -->
            <div>
                <span style='color: #a6b3be;'>© 2020 InstaClone  by Lahcen EL hanchir</span>
            </div>
        </div>
        {{-- Main section --}}


        <div class="col-md-8 px-2 shadow-lg rounded">
